...
const FoodCard = ({item}) => {
    ...
    return (
        ...
        <Link to={token?`/${item._id}`:'/login'} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div>
            ...
            <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">4 star</p>
